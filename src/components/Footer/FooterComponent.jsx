...
const FooterComponent = () => {
    ...
    const basicGroupSize = Math.floor(numCategories / numGroups);
    const remainder = numCategories % numGroups;

    const chunkedCategories = [];
    let startIndex = 0;

    for (let i = 0; i < numGroups; i++) {
        const endIndex = startIndex + basicGroupSize + (i < remainder ? 1 : 0);
        chunkedCategories.push(categories.slice(startIndex, endIndex));
        startIndex = endIndex;
    }
    ...
    return (
        <footer style={{ marginTop: '20px' }} class="styles__Wrapper-sc-32ws10-0 hoKyYL">
            ...
            <div class="styles__Addresses-sc-32ws10-2 eUGZqm"><div style={{ display: 'flex' }} class="Container-sc-itwfbd-0 hfMLFx">
                <div class="address">
                    ...
                    <div class="address-info">
                        <p class="title-text">Cửa hàng MTA Store</p>
                        <p class="small-text">số 236 đường Hoàng Quốc Việt, phường Cổ Nhuế 1, quận Bắc Từ Liêm, thành phố Hà Nội</p>
            ...
            <div style={{ width: '1270px', paddingLeft: '15px', paddingRight: '15px', marginRight: 'auto', marginLeft: 'auto' }}>
                <div class="styles__StyledCategoryList-sc-17y817k-0 dNFPjn">
                    <div class="styles__FooterHeading-sc-32ws10-4 fdMvyN">Danh Mục Sản Phẩm</div>
                    <div className="styles__StyledColumns-sc-17y817k-2 gteCFh">
                        {chunkedCategories.map((group, index) => (
                            <div key={index} className="styles__StyledColumn-sc-17y817k-3 dnQfHY">
                                {group.map((category, subIndex) => (
                                    <div key={subIndex} className="styles__StyledCategory-sc-17y817k-1 iBByno">
                                        <div className="styles__FooterSubheading-sc-32ws10-5 cNJLWI">
                                            <a
                                                onClick={() => {
                                                    onClick(category.name, category._id)
                                                }}
                                            >{category.name}</a>
                                        </div>
                                    </div>
